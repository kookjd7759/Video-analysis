...
class koceti_worker:
    def __init__(self, target_ip, port, main_crane_port, data_queue, shared_state, period_sec=1.0):
        ...
        self.crane_tester = Crane_Final_Test(target_ip=self.target_ip, port=self.port)
        ...
        try:
            ...
            while not self._stop.is_set():
                ...
                if final_data is None:
                    ...
                    # shared_state 위험도 갱신
                    risk_level = final_data.get("risk_assessment", 0)
